(function () {
	...
	*/
	...
	function section1Animation(){
	    gsapWithCSS.from("#section-1 div",{duration:1, alpha:0, y:400});
	}
	...
	*/
	...
	const section2TL = gsapWithCSS.timeline();
	...
	const section3TL = gsapWithCSS.timeline();
	...
	const section4TL = gsapWithCSS.timeline();
	...
	const section6TL = gsapWithCSS.timeline();
	...
	var $burger = jquery("#burger-icon");
	var $nav = jquery('nav[data-nav]');
	var $navA = jquery('nav[data-nav] a');
	var isVisible = false;
